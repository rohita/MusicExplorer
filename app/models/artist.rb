...
class Artist
  ...
  attr_accessor :name
  attr_accessor :image64_url
  attr_accessor :image252_url
  attr_accessor :bio
  ...
  def self.find(input_name)
    ...
    artist.image64_url = doc.xpath("artist/image[@size='medium']").first.content
    artist.image252_url = doc.xpath("artist/image[@size='extralarge']").first.content
